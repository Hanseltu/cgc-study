For each source code of the cgc program, I added a "fprintf" before and after the location of errors reported by KLEE (changed source code are in `challenge-debug` folder).
